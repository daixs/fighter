...
module fighter
{
    ...
    export class GameContainer extends egret.DisplayObjectContainer
    {
        ...
        /**触发创建敌机的间隔*/
        private enemyFightersTimer:egret.Timer = new egret.Timer(700);
        /**敌人的子弹*/
        private enemyBullets:fighter.Bullet[] = [];
        /**成绩显示*/
       // private scorePanel: fighter.ScorePanel;
      //  private overPlan: fighter.OverPlan;

        private overPlan: fighter.EndPlan;
        ...
        private preCreatedInstance():void {
            ...
            for (var i: number = 0; i < 20; i++) {
                ...
                var enemyFighter: fighter.Airplane = fighter.Airplane.produce(fname,700);
        ...
        private createEnemyFighter(evt:egret.TimerEvent):void{
            var enemyFighter:fighter.Airplane = fighter.Airplane.produce("f2",700);
            ...
            { 
                var lastenemyFighter: fighter.Airplane = this.enemyFighters[this.enemyFighters.length - 1];
        ...
        private gameViewUpdate(evt:egret.Event):void{
            ...
            var fps:number = 700/(nowTime-this._lastTime);
        ...
        public plan_over(_b: boolean= true) {
            if (_b) {
